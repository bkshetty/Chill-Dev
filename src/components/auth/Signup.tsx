    ...
    <div className="min-h-screen bg-dark-900 flex items-center justify-center p-4">
      ...
      >
        ...
        <form onSubmit={handleEmailSignup} className="space-y-5">
          ...
          >
            <label htmlFor="displayName" className="block text-sm font-semibold text-gray-300 mb-2.5">
              Full Name
            </label>
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full pl-10 pr-12 py-3 bg-dark-700 bg-opacity-50 border border-gray-700 border-opacity-50 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-500"
